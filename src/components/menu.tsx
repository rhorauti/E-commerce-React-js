    ...
    <>
      <div className="sticky top-0 py-2 md:px-4 bg-blue-950 flex items-center text-white">
        ...
        <div className="flex items-center gap-6 md:mx-4 mx-2 w-full">
          <div className="flex grow p-2 md:w-full">
            <select
      ...
      <div className="md:hidden w-full flex items-center justify-evenly fixed bottom-0 left-0 py-2 bg-blue-950 text-white">
